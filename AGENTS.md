...
internal/updatecheck   answers whether a newer Cartographer release exists and how this binary is upgraded (D254)
...
- **This repository is public**: commits, docs, tests, issues, PRs and comments never carry a real name from a private setup (KB names, hosts, usernames, employer or client) — measurements use placeholders like `kb-a`; the `privacy` workflow enforces it (D259).
