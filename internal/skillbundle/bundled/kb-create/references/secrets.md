...
secret_refs:
  - CLIENT_SECRET=secrets/keycloak.sops.yaml#/work_client/DEV/client_secret
...
```
secret_set(path: "secrets/keycloak.sops.yaml", key: "/work_client/DEV/client_secret", value: "<new>")
```
...
the pointers are `/work_client/DEV/client_secret` and `/admin/0/client_secret` —
