...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function bm(i,t,e){return new pn({name:"SphericalGaussianBlur",defines:{SAMPLES:vm,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:es(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function hl(){return new pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:es(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function ul(){return new pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:es(),fragmentShader:`
