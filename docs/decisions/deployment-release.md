...
**Status: implemented (2026-07-31); Homebrew path amended by [D199](#d199).**
Supersedes the manual-restart portion of [D95](#d95), for supported native
...
- **The Cask deprecation is upstream's, and is recorded as such.** Item 13 of the plan prescribed
  ...
  [D199](#d199): `custom_block` is GoReleaser's supported way to emit such a stanza.*
...
**Status: implemented (2026-09-12).** Amends [D121](#d121) for the Homebrew path; supersedes
[D192](#d192)'s finding that the Cask deprecation was not fixable here.
