...
**Status: superseded by [D238](D238-windows-installs-through-install-ps1-not-winget.md)** — winget was withdrawn and Windows installs through `install.ps1` (the zip format below still stands).
