...
234 records, one file each, grouped by the topic they belong to.
...
- [D238 — Windows installs through install.ps1, not winget](decisions/D238-windows-installs-through-install-ps1-not-winget.md)
